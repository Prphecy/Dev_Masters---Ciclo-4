...
> {
  ...
  constructor(
    @inject('datasources.EcoMongoDB') dataSource: EcoMongoDbDataSource, @repository.getter('UsuarioRepository') protected usuarioRepositoryGetter: Getter<UsuarioRepository>,
  ) {
